...
import type { Channel, Goal, Meeting, Task } from "@/lib/types";

type Form = { name: string; template: string; grade: string; location: string; workMode: string; manager: string; buddy: string; start: string };
